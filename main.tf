...
resource "aws_launch_template" "main" {
  ...
  # Once autoscaling is sees less traffic, it will terminate the instances.
...
#If it is frontend - frontend-dev.daws88c.online
resource "aws_lb_listener_rule" "main" {
  listener_arn = local.alb_listener_arn_id
